window.onload=()=>{
    ...
    // let subcodesel_child=subject_num_code_select_tag.lastElementChild;
    //     while(subcodesel_child)
    //     {
    //         subcodesel_child.remove();
    //         subcodesel_child=subject_num_code_select_tag.lastElementChild;
    //     }
    close_popup.onclick=()=>{
